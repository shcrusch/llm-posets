...
for mu in {0.5,0.7,0.9,0.95,0.97,0.99}; do
    python $srcdir/run.py $datadir/mushroom.dat $datadir/mushroom.dat_itemsets acc_grad 1 1001 $mu > $basedir/experiments/mushroom/acc_grad_$mu.txt 2> $basedir/experiments/mushroom/log/acc_grad_$mu.log &
