...
python $srcdir/run.py $datadir/connect.dat $datadir/connect.dat_itemsets coor > $basedir/experiments/connect/coor.txt 2> $basedir/experiments/connect/log/coor.log &
