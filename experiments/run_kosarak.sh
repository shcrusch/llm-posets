...
#python $srcdir/run.py kosarak coor_l1 0.001 1001 > $basedir/experiments/kosarak/regularized/coor_l1.txt 2> $basedir/experiments/kosarak/regularized/log/coor_l1.log &

#for step in {0.01,0.1,1,10}; do
#    python $srcdir/run.py kosarak prox $step 0.001 1001 > $basedir/experiments/kosarak/regularized/prox_$step.txt 2> $basedir/experiments/kosarak/regularized/log/prox_$step.log &
#done

#for step in {1,2,5,10,20}; do
#    python $srcdir/run.py kosarak rda $step 0.001 1001 > $basedir/experiments/kosarak/regularized/rda_$step.txt 2> $basedir/experiments/kosarak/regularized/log/rda_$step.log &
#done
